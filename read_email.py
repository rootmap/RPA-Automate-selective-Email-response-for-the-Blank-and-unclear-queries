...
password = "S@K!#$20ul"
path = "F:\\Python Projects\\EmailAutomationBackground"
...
#imap_session.starttls() #enable security
print("login successful")
# print(imap_session.list())

status, messages = imap_session.select("INBOX")

# blank_messages = imap_session
        ...
        if isinstance(response, tuple):
            ...
            if msg.is_multipart():
                ...
                if content_type == "text/plain":
                    ...
                    print("enter in text/plain")
                    print(body)
            if content_type == "text/html":
                print("enter in text/html")
